...
import com.cbkj.rrh.ui.contacts.group.GroupBusinessChatSettingActivity;
import com.cbkj.rrh.ui.contacts.group.GroupNormalChatSettingActivity;
import com.cbkj.rrh.ui.contacts.persion.PersionChatSettingActivity;
 ...
 */
public class ContactChatTypeActivity extends FragmentActivity implements Handler.Callback,TitleBar.TitleBarListener {

    private static final String TAG = ContactChatTypeActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.a_contact_chat_type);
        this.initView();
        this.initData();
    }
...
//          }
      	...
      	titleBar.setOther("设置", 0, "groupBusinessSetting");//persionSetting
...
//          }
      	...
      	//普通群
      	titleBar.setOther(null, R.drawable.contacts_group_setting_icon, "groupNormalSetting");
      	//认证群
      	titleBar.setOther(null, R.drawable.contacts_group_setting_icon, "groupBusinessSetting");
              ...
              RongIM.getInstance().getRongIMClient().getPublicServiceProfile(Conversation.PublicServiceType.APP_PUBLIC_SERVICE,
                      targetId, new RongIMClient.ResultCallback<PublicServiceInfo>() {
                          ...
                          public void onSuccess(PublicServiceInfo publicServiceInfo) {
                          	 titleBar.setTitle(publicServiceInfo.getName().toString());
                          }
                          @Override
...
//                intent.getData().getLastPathSegment();//获得当前会话类型
        ...
        if (fragment != null) {
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.add(R.id.contact_chat_type_fl, fragment, tag);
            transaction.addToBackStack(null).commitAllowingStateLoss();
        }
    }
...
//        getSupportActionBar().setTitle(sb);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (fragment != null) {
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.contact_chat_type_fl, fragment, tag);
            transaction.addToBackStack(null).commitAllowingStateLoss();
        }
    }
...
//                    WinToast.toast(ContactCharTypeActivity.this, "讨论组尚未创建成功");
                }
            }
        }
    }
	...
	public void onHeaderOtherButton(View v) {
		if(v.getTag().equals("persionSetting")){
			//个人聊天--设置
			Intent intent=new Intent(this,PersionChatSettingActivity.class);
			this.startActivity(intent);
		}else if(v.getTag().equals("groupNormalSetting")){
			//普通群--设置
			Intent intent=new Intent(this,GroupNormalChatSettingActivity.class);
			this.startActivity(intent);
		}else if(v.getTag().equals("groupBusinessSetting")){
			//认证群--设置
			Intent intent=new Intent(this,GroupBusinessChatSettingActivity.class);
			this.startActivity(intent);
		}
	}
    @Override
