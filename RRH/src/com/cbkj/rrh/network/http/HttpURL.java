package com.cbkj.rrh.network.http;
...
public class HttpURL {
 	...
 	public static final String BASE_URL = "http://192.168.1.118:9092";//     	测试环境∂public static final String BASE_URL = "http://192.168.1.118:8080/llsh";//     	测试环境
	
	/*****************************************************用户模块*************************************************************/
	
	/**验证手机号，并获取手机验证码**/
	public static final String URL_PHONE_CHECK_VERIFYCODE = BASE_URL + "/account/checkCreateVerifyCode";
	...
	/**获取接单人认证参数*/
	public static final String URL_EMPLOYEE_INFO = BASE_URL + "/employeeApplyInfo";
