...
public class SwitchGroup extends ViewGroup {
    ...
    private ItemHander mItemHander;
                    ...
                    if (frame.contains(scrolledXInt, scrolledYInt)) {
                        if (!child.isSelected()) {
                            ...
                            if (child instanceof SwitchItemView) {
                            	SwitchItemView switchItemView=(SwitchItemView)child;
                            	switchItemView.handlerPinnedView(mPinnedView);
                                if (mItemHander != null)
                                    mItemHander.onSwitchGroupItem(switchItemView);
                                invalidate();
                            }
                        }
                    } else {
